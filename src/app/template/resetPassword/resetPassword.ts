...
const returnSection = (reportLink: string) => `
																	...
																	<tr>
																		<td class="pad" style="padding-bottom:10px;padding-left:60px;padding-right:60px;padding-top:10px;">
																			<div style="color:#091f5c;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:center;mso-line-height-alt:19px;">
																				<p style="margin: 0;">If you did not request password reset verification, please ignore this email or report it by clicking the button below.</p>
																			</div>
																		</td>
																	</tr>
																</table>
																...
																<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																	<tr>
																		<td class="pad" style="width:100%;">
																			<div class="alignment" align="center">
																				<div style="max-width: 93px;"><img src=${URL.reset_password_url} style="display: block; height: auto; border: 0; width: 100%;" width="93" alt title height="auto"></div>
																			</div>
																		</td>
																	</tr>
																</table>
																	...
																	<tr>
																		<td class="pad">
																			<div style="color:#091f5c;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.5;text-align:center;mso-line-height-alt:24px;">
																				<p style="margin: 0;">We received a request to reset the password for your ${userName} account.<br>Click the button below to proceed and create a new password.</p>
																			</div>
																		</td>
																	</tr>
																</table>
...
<![endif]--><span class="button" style="background-color: #0095ff; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 9px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: 400; mso-border-alt: none; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span class="btn-pad" style="word-break: break-word; padding-left: 25px; padding-right: 25px; padding-top: 5px; padding-bottom: 5px; display: block;"><span style="word-break: break-word; line-height: 40px;">Reset your password</span></span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></a></div>
																		</td>
																	</tr>
																</table>
																	...
																	<tr>
																		<td class="pad">
																			<div style="color:#091f5c;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:700;letter-spacing:0px;line-height:1.2;text-align:center;mso-line-height-alt:19px;">
																				<p style="margin: 0;">This password reset is only valid for the next ${expiryTime}.</p>
																			</div>
																		</td>
																	</tr>
																</table>
					...
					${reportButtonStatus ? returnSection(reportLink) : ""}
