...
export default ({
  companyName = "",
  verifyEmailUrl = "https://www.google.com",
														...
														<tr>
															<td class="col-pad" style="padding-bottom:5px;padding-top:5px;">
																	...
																	<tr>
																		<td class="pad">
																			<div style="color:#091f5c;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.5;text-align:center;mso-line-height-alt:24px;">
																				<p style="margin: 0;">To finalize your account setup ${companyName ? "with" : ""} ${companyName}, we need to verify your identity. This ensures the highest level of security for your account and protects your personal information. Click the button below to verify your email address.</p>
																			</div>
																		</td>
																	</tr>
																</table>
																...
																<table class="button_block block-8" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																	<tr>
																		<td class="pad">
																			<div class="alignment" align="center"><a href=${verifyEmailUrl} target="_blank" style="color:#ffffff;text-decoration:none;"><!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="https://www.google.com/"  style="height:44px;width:149px;v-text-anchor:middle;" arcsize="21%" fillcolor="#0095ff">
...
<![endif]--><span class="button" style="background-color: #0095ff; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 9px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, Helvetica, sans-serif; font-size: 17px; font-weight: 400; mso-border-alt: none; text-align: center; width: auto; word-break: keep-all; letter-spacing: 1px;"><span class="btn-pad" style="word-break: break-word; padding-left: 25px; padding-right: 25px; padding-top: 5px; padding-bottom: 5px; display: block;"><span style="word-break: break-word; line-height: 34px;">Verify email</span></span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></a></div>
																		</td>
																	</tr>
																</table>
