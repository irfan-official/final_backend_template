    ...
    <style>
      * {
      ...
      @media (max-width: 620px) {
        ...
        .row-4 .column-1 .block-4.social_block .alignment table,
        ...
        .row-4 .column-1 .block-4.social_block td.pad {
        ...
        .row-4 .column-1 .block-4.social_block .alignment {
          text-align: center !important;
        }
        ...
        .row-3 .column-1 .block-5.heading_block h1 {
                                      ...
                                      <td class="pad" style="width: 100%">
                                        <div class="alignment" align="center">
                                          <div style="max-width: 93px">
                                            <img
                                              src="https://08608989b4.imgdist.com/pub/bfra/4sssds1u/xi2/zjk/qsp/Slogo.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                  ...
                                  >
                                    <tr>
                                      <td class="pad">
                                        ...
                                        >
                                          <p style="margin: 0">
                                            To finalize your account setup with
                                            $CompanyName, we need to verify your
                                            identity. This ensures the highest
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        ...
                                        >
                                          <p style="margin: 0">
                                            This process helps us comply with
                                            financial regulations and ensures a
                                            safe experience for all our clients.
                                          </p>
                                        </div>
                                      </td>
                                    </tr>
                  ...
                  <td>
                    <table
                      ...
                      style="
                        ...
                        mso-table-rspace: 0pt;
                        background-color: #ffffff;
                        border-bottom: 1px solid #081b5d;
                        border-left: 1px solid #081b5d;
                        border-right: 1px solid #081b5d;
                        border-top: 1px solid #081b5d;
                        color: #000000;
                        width: 600px;
                        margin: 0 auto;
                      "
